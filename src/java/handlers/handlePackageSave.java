 ...
 * @author codeguy
 */
@WebServlet(name = "handlePackageSave", urlPatterns = {"/handlePackageSave"})
public class handlePackageSave extends HttpServlet {
          ...
          //  String servicePrice = "";
            ...
            for (FileItem item : items) {
                if (item.isFormField()) {
                    ...
                    if (item.getFieldName().equals("pdescription")) {
                        packageDescription = item.getString();
                    }
                } else {
            ...
            POJOs.DoctorClasses classes = new POJOs.DoctorClasses();
            classes.setClassDescr(packageDescription);
            classes.setClassName(packageName);
            classes.setClassImage(path);
