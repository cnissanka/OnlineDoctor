 ...
 * @author codeguy
 */
@WebServlet(name = "handleMedicineService", urlPatterns = {"/handleMedicineService"})
public class handleMedicineService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println(servicePrice + " is price???");
            ...
            session.close();
            tf = null;
            response.sendRedirect("admin/admin_medicalservice.jsp?res=success");
